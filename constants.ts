...
export const TEXT = {
  en: {
    ...
    copied: "COPIED!",
    error: "INVALID DATA",
    importPrompt: "Paste level JSON here:",
    startOverlayTitle: "Ready to start?",
    startOverlayHint: "Press the button or use keyboard E / gamepad A to begin.",
    startOverlayButton: "Start Game",
    toolLabels: {
      wall: "WALL",
      dark: "DARK TILE",
      light: "LIGHT TILE",
  ...
  zh: {
    ...
    copied: "已复制!",
    error: "数据无效",
    importPrompt: "请粘贴关卡 JSON：",
    startOverlayTitle: "准备好开始了吗？",
    startOverlayHint: "点击按钮或使用键盘 E / 手柄 A 即可开始游戏。",
    startOverlayButton: "开始游戏",
    toolLabels: {
      wall: "墙体",
      dark: "黑地块",
      light: "白地块",
